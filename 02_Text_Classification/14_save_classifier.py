...
import pickle # this will be used to save the classifier
...
reviews_classifier = open("reviews_classifier.pickle", "wb") # same directory as this script
pickle.dump(classifier, reviews_classifier)
reviews_classifier.close()

# Opening and loading the classifier
print('Opening and loading the classifier...\n')
reviews_classifier = open("reviews_classifier.pickle", "rb")
bayes_classifier = pickle.load(reviews_classifier)
reviews_classifier.close()

# Checking accuracy with the newly loaded classifier
print('Algorithm accuracy (%):', nltk.classify.accuracy(bayes_classifier, testing_set) * 100)
